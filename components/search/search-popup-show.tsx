...
export const SearchPopupTriggerShow = () => {
  ...
  return (
    ...
    >
      <SearchIcon className="h-5 w-5 stroke-black" />
    </Button>
  );
};

const SearchPopupShow = () => {
  const [open, setOpen] = useAtom(searchPopupAtom);
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal>
      <PopoverTrigger asChild>
        ...
        <PopoverContent
          className="w-screen border-b-0 border-x-0 px-0 bg-white drop-shadow-md rounded-b-lg "
          sideOffset={0}
        >
        <div className="container">
          <div className="flex items-center relative">
            ...
            />
            <Input
              className="border-none shadow-none pl-12 focus-visible:ring-0 text-sm py-8 h-auto"
            ...
            <>
              <div className="flex items-center justify-between border-b pb-3 mb-4 font-medium text-sm">
                ...
                <Button variant="ghost" asChild>
                  ...
                  > 
                    <MoveRight strokeWidth={1.5} className="stroke-[#3fac53]" />
                  </Link>
                </Button>
              </div>
...
export default SearchPopupShow;
